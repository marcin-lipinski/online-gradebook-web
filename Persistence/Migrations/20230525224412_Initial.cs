    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DivisionSubjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DivisionSubjects_Divisions_DivisionId",
                        column: x => x.DivisionId,
                        principalTable: "Divisions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DivisionSubjects_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DivisionSubjetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DivisionSubjects_DivisionId",
                table: "DivisionSubjects",
                column: "DivisionId");

            migrationBuilder.CreateIndex(
                name: "IX_DivisionSubjects_SubjectId",
                table: "DivisionSubjects",
                column: "SubjectId");

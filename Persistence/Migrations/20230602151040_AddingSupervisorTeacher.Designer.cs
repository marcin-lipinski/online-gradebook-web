...
namespace Persistence.Migrations
{
    ...
    [Migration("20230602151040_AddingSupervisorTeacher")]
    partial class AddingSupervisorTeacher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Division", b =>
                {
                    ...
                    b.HasIndex("SupervisingTeacherId")
                        .IsUnique()
                        .HasFilter("[SupervisingTeacherId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Teacher", b =>
                {
                    ...
                    b.Property<Guid>("SupervisedDivisionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Division", b =>
                {
                    b.HasOne("Domain.Teacher", "SupervisingTeacher")
                        ...
                        .HasForeignKey("Domain.Division", "SupervisingTeacherId");
            ...
            modelBuilder.Entity("Domain.Teacher", b =>
                {
                    ...
                    b.Navigation("SupervisedDivision");
                });
